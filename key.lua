...
local Config = {
    ...
    ServiceId       = 30270, -- Your PlatoBoost Service ID
    PlatoSecret     = "1ff6e02f-8f84-4e71-967a-8e7235c0158b", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "giuliano", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/parkourgiuli-svg/keyssystem/refs/heads/main/script.lua", -- The raw URL of your main script
    
    -- [4] Social Media Settings (Set to true to show, false to hide)
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/3mVrK3zGc",
    
    ShowInstagram   = false,
    InstagramURL    = "https://www.instagram.com/oyb0i/",
    
    ShowYoutube     = true,
    YoutubeURL      = "https://www.youtube.com/channel/UCa2zxc0LnrPEqWIoFbVGXDA",
    ...
    HubName         = "Zvolt", -- The main title shown at the top of the GUI
    HubDescription  = "Scritp aimbot+esp universal" -- The text shown below the title
}
